...
announce_window_header = f'{target_application} programmer {DEF_version}'
...
#print(announce_window_header)
# Display the window and get values
window = sg.Window(announce_window_header, layout = layout, resizable = True, margins=(0,0), element_padding=(0,0),enable_close_attempted_event=True, finalize=True)
